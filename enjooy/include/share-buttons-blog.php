                            <div class="post-submeta">
                                ...
                                <a href="<?php the_permalink() ?>#comments" class="content-color"><i class="oic-simple-line-icons-73"></i><span><?php comments_number('0', '1', '%') ?></span></a>
                                <?php } ?>
                                <a href="<?php the_permalink() ?>" class="content-color blog-like-link" data-post_id="<?php echo $post->ID; ?>"><i class="oic-simple-line-icons-137"></i><span><?php echo (int)get_post_meta($post->ID, "ozy_post_like_count", true); ?></span></a>
                               	<?php if(!$hide_title) { ?>
                                <a href="<?php the_permalink() ?>" class="content-color post-share" data-open="0"><i class="oic-simple-line-icons-90"></i></a>
                                <div>
                                	<div class="arrow"></div>
                                    <div class="button">
