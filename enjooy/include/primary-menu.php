		...
		?>
            <div id="side-nav-bar">
                ...
                <div id="bottom-elements">
                    ...
                    ?>                
                    <h3 id="ozy-language-selector-title" class="<?php echo ozy_get_option('primary_menu_stay_connected') === '-1' ? 'bottom-line' : '' ?>"><i class="oic oic-simple-line-icons-135">&nbsp;</i><?php echo ICL_LANGUAGE_NAME ?></h3>
					...
					if(ozy_get_option('primary_menu_stay_connected') !== '-1') {
                    ?>
