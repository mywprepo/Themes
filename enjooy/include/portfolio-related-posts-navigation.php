		        	...
		        	if(ozy_get_option('page_portfolio_related_posts') != '1') {
                        ...
                        if( $related_posts_query->have_posts() ) {
                            ...
                            while ($related_posts_query->have_posts()) : $related_posts_query->the_post();
								$shortcode_list.= '[ozy_vc_owlcarousel2 img_size="showbiz" default_overlay="on" src="'. get_post_thumbnail_id() .'" title="'. get_the_title() .'" excerpt="" link="'. get_permalink() .'"]';//'. ozy_excerpt_max_charlength(get_the_excerpt()) .'
                            endwhile;
