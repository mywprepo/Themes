...
?>
	...
	if ( have_posts() ) while ( have_posts() ) : the_post(); 
		...
		if( 'full-page-slider' === $post_format || 
			'full-page-accordion-slider' === $post_format || 
			...
			<article>
				...
				<?php
					...
					if( 'inpage-slider' === $post_format || 'inpage-slider-full' === $post_format ) {
						...
						echo $ozyHelper->convert_videos( vp_metabox('ozy_enjooy_meta_portfolio.ozy_enjooy_meta_portfolio_custom_thumbnail_group.0.ozy_enjooy_meta_portfolio_custom_thumbnail_video') );
					} 
					else if( 'video' !== $post_format 
					...
					// Accordion Slider
						...
						include_once(locate_template('include/portfolio-accordion-gallery.php'));
					}
