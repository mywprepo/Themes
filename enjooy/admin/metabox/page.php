...
return array(
	...
	'template'    => array(
		array(
			'type' => 'select',
			'name' => 'ozy_enjooy_meta_page_revolution_slider',
			...
			'items' => array(
				'data' => array(
					array(
						'source' => 'function',
						'value' => 'vp_bind_ozy_enjooy_revolution_slider',
					),
				),
			),
			'default' => '{{first}}',
		...
		array(
			'type' => 'select',
			'name' => 'ozy_enjooy_meta_page_master_slider',
			...
			'items' => array(
				'data' => array(
					array(
						'source' => 'function',
						'value' => 'vp_bind_ozy_enjooy_master_slider',
					),
				),
			),
			'default' => '{{first}}',
		...
		array(
			'type' => 'select',
			'name' => 'ozy_enjooy_meta_page_showbiz_slider',
			'label' => __('Showbiz Header Slider', 'vp_textdomain'),
			'description' => __('You can select a header slider if you have installed and activated Showbiz Slider which comes bundled with your theme. Not available in Portfolio templates.', 'vp_textdomain'),
			'items' => array(
				'data' => array(
					array(
						'source' => 'function',
						'value' => 'vp_bind_ozy_enjooy_showbiz_slider',
					),
				),
			),
			'default' => '{{first}}',
		...
		array(
			'type' => 'toggle',
			'name' => 'ozy_enjooy_meta_page_use_footer_slider',
		...
		array(
			...
			'repeating' => false,
			'length'    => 1,
			'name'      => 'ozy_enjooy_meta_page_use_footer_slider_group',
			'title'     => __('Footer Slider', 'vp_textdomain'),
			'dependency' => array(
				'field'    => 'ozy_enjooy_meta_page_use_footer_slider',
				'function' => 'vp_dep_boolean',
			),
			'fields'    => array(
				array(
					'type' => 'select',
					'name' => 'ozy_enjooy_meta_page_revolution_footer_slider',
				...
				array(
					'type' => 'select',
					'name' => 'ozy_enjooy_meta_page_master_footer_slider',
				...
				array(
					'type' => 'select',
					'name' => 'ozy_enjooy_meta_page_showbiz_footer_slider',
					'label' => __('Showbiz Footer Slider', 'vp_textdomain'),
					'description' => __('You can select a footer slider if you have installed and activated Showbiz Slider which comes bundled with your theme. Not available in Portfolio templates.', 'vp_textdomain'),
					'items' => array(
						'data' => array(
							array(
								'source' => 'function',
		...
		array(
			'type' => 'toggle',
			'name' => 'ozy_enjooy_meta_page_show_loader',
		...
		array(
			'type' => 'toggle',
			'name' => 'ozy_enjooy_meta_page_hide_footer_widget_bar',
		...
		array(
			...
			'repeating' => false,
			'length'    => 1,
			'name'      => 'ozy_enjooy_meta_page_use_custom_title_group',
			'title'     => __('Custom Header/Title Options', 'vp_textdomain'),
			'dependency' => array(
				'field'    => 'ozy_enjooy_meta_page_use_custom_title',
				'function' => 'vp_dep_boolean',
			),
			'fields'    => array(
				/*array(
					'type' => 'radiobutton',
					'name' => 'ozy_enjooy_meta_page_custom_title_nopadding',
				...
				array(
					'type' => 'radiobutton',
					'name' => 'ozy_enjooy_meta_page_custom_title_position',
				...
				array(
					'type'      => 'textbox',
					'name'      => 'ozy_enjooy_meta_page_custom_title',
					'label'     => __('Page Title', 'vp_textdomain'),
				),
				array(
					'type'      => 'color',
					'name'      => 'ozy_enjooy_meta_page_custom_title_color',
				...
				array(
					'type'      => 'textbox',
					'name'      => 'ozy_enjooy_meta_page_custom_sub_title',
					'label'     => __('Sub Title', 'vp_textdomain'),
				),
				array(
					'type'      => 'color',
					'name'      => 'ozy_enjooy_meta_page_custom_sub_title_color',
				...
				array(
					'type'      => 'color',
					'name'      => 'ozy_enjooy_meta_page_custom_title_bgcolor',
				...
				array(
					'type'      => 'upload',
					'name'      => 'ozy_enjooy_meta_page_custom_title_bg',
				...
				array(
					'type' => 'radiobutton',
					'name' => 'ozy_enjooy_meta_page_custom_title_bg_x_position',
				...
				array(
					'type' => 'radiobutton',
					'name' => 'ozy_enjooy_meta_page_custom_title_bg_y_position',
				...
				array(
					'type'      => 'textbox',
					'name'      => 'ozy_enjooy_meta_page_custom_title_height',
		...
		array(
			'type' => 'toggle',
			'name' => 'ozy_enjooy_meta_page_hide_content',
		...
		array(
			'type' => 'toggle',
			'name' => 'ozy_enjooy_meta_page_use_sidebar',
		...
		array(
			...
			'repeating' => false,
			'length'    => 1,
			'name'      => 'ozy_enjooy_meta_page_sidebar_group',
			'title'     => __('Custom Sidebar', 'vp_textdomain'),
			'dependency' => array(
				'field'    => 'ozy_enjooy_meta_page_use_sidebar',
				'function' => 'vp_dep_boolean',
			),
			'fields'    => array(
				array(
					'type' => 'radioimage',
					'name' => 'ozy_enjooy_meta_page_sidebar_position',
				...
				array(
					'type' => 'select',
					'name' => 'ozy_enjooy_meta_page_sidebar',
		...
		array(
			'type' => 'toggle',
			'name' => 'ozy_enjooy_meta_page_use_custom_style',
		...
		array(
			...
			'repeating' => false,
			'length'    => 1,
			'name'      => 'ozy_enjooy_meta_page_layout_group',
			'title'     => __('Layout Styling', 'vp_textdomain'),
			'dependency' => array(
				'field'    => 'ozy_enjooy_meta_page_use_custom_style',
				'function' => 'vp_dep_boolean',
			),
			'fields'    => array(					
				array(
					'type' => 'color',
					'name' => 'ozy_enjooy_meta_page_layout_ascend_background',
				...
				array(
					'type' => 'toggle',
					'name' => 'ozy_enjooy_meta_page_layout_transparent_background',
		...
		array(
			'type' => 'toggle',
			'name' => 'ozy_enjooy_meta_page_use_custom_background',
		...
		array(
			'type'      => 'group',
			'repeating' => false,
			'name'      => 'ozy_enjooy_meta_page_background_group',
			'title'     => __('Background Styling', 'vp_textdomain'),
			'dependency' => array(
				'field'    => 'ozy_enjooy_meta_page_use_custom_background',
				'function' => 'vp_dep_boolean',
			),
			'fields'    => array(					
				array(
					'type' => 'upload',
					'name' => 'ozy_enjooy_meta_page_background_image',
					'label' => __('Custom Background Image', 'vp_textdomain'),
					'description' => __('Upload or choose custom page background image.', 'vp_textdomain'),
				),
				array(
					'type' => 'radiobutton',
					'name' => 'ozy_enjooy_meta_page_background_image_size',
				...
				array(
					'type' => 'radiobutton',
					'name' => 'ozy_enjooy_meta_page_background_image_repeat',
				...
				array(
					'type' => 'radiobutton',
					'name' => 'ozy_enjooy_meta_page_background_image_attachment',
				...
				array(
					'type' => 'color',
					'name' => 'ozy_enjooy_meta_page_background_color',
					'label' => __('Background Color', 'vp_textdomain'),
				...
				array(
					'type' => 'toggle',
					'name' => 'ozy_enjooy_meta_page_background_use_gmap',
				...
				array(
					'type'      => 'group',
					'repeating' => false,
					'name'      => 'ozy_enjooy_meta_page_background_gmap_group',
					'title'     => __('Google Map', 'vp_textdomain'),
					'dependency' => array(
						'field'    => 'ozy_enjooy_meta_page_background_use_gmap',
						'function' => 'vp_dep_boolean',
					),
					'fields'    => array(					
						array(
							'type' => 'textbox',
							'name' => 'ozy_enjooy_meta_page_background_gmap_address',
				...
				array(
					'type' => 'toggle',
					'name' => 'ozy_enjooy_meta_page_background_use_slider',
				...
				array(
					...
					'repeating' => true,
					'sortable' => true,
					'name'      => 'ozy_enjooy_meta_page_background_slider_group',
					'title'     => __('Slider Image', 'vp_textdomain'),
					'dependency' => array(
						'field'    => 'ozy_enjooy_meta_page_background_use_slider',
						'function' => 'vp_dep_boolean',
					),
					'fields'    => array(					
						array(
							'type' => 'upload',
							'name' => 'ozy_enjooy_meta_page_background_slider_image',
				...
				array(
					'type' => 'toggle',
					'name' => 'ozy_enjooy_meta_page_background_use_video_self',
				...
				array(
					...
					'repeating' => false,
					'sortable' => false,
					'name'      => 'ozy_enjooy_meta_page_background_video_self_group',
					'title'     => __('Self Hosted Video', 'vp_textdomain'),
					'dependency' => array(
						'field'    => 'ozy_enjooy_meta_page_background_use_video_self',
						'function' => 'vp_dep_boolean',
					),
					'fields'    => array(					
						array(
							'type' => 'upload',
							'name' => 'ozy_enjooy_meta_page_background_video_self_image',
							'label' => __('Poster Image', 'vp_textdomain'),
							'description' => __('Upload or choose a poster image.', 'vp_textdomain'),
						),
						array(
							'type' => 'upload',
							'name' => 'ozy_enjooy_meta_page_background_video_self_mp4',
							'label' => __('MP4 File', 'vp_textdomain'),
							'description' => __('Upload or choose a MP4 file.', 'vp_textdomain'),
						),
						array(
							'type' => 'upload',
							'name' => 'ozy_enjooy_meta_page_background_video_self_webm',
							'label' => __('WEBM File', 'vp_textdomain'),
							'description' => __('Upload or choose a WEBM file.', 'vp_textdomain'),
						),
						array(
							'type' => 'upload',
							'name' => 'ozy_enjooy_meta_page_background_video_self_ogv',
				...
				array(
					'type' => 'toggle',
					'name' => 'ozy_enjooy_meta_page_background_use_video_youtube',
				...
				array(
					...
					'repeating' => false,
					'sortable' => false,
					'name'      => 'ozy_enjooy_meta_page_background_video_youtube_group',
					'title'     => __('YouTube Video', 'vp_textdomain'),
					'dependency' => array(
						'field'    => 'ozy_enjooy_meta_page_background_use_video_youtube',
						'function' => 'vp_dep_boolean',
					),
					'fields'    => array(					
						array(
							'type' => 'upload',
							'name' => 'ozy_enjooy_meta_page_background_video_youtube_image',
							'label' => __('Poster Image', 'vp_textdomain'),
							'description' => __('Upload or choose a poster image.', 'vp_textdomain'),
						),
						array(
							'type' => 'textbox',
							'name' => 'ozy_enjooy_meta_page_background_video_youtube_id',
				...
				array(
					'type' => 'toggle',
					'name' => 'ozy_enjooy_meta_page_background_use_video_vimeo',
				...
				array(
					...
					'repeating' => false,
					'sortable' => false,
					'name'      => 'ozy_enjooy_meta_page_background_video_vimeo_group',
					'title'     => __('Vimeo Video', 'vp_textdomain'),
					'dependency' => array(
						'field'    => 'ozy_enjooy_meta_page_background_use_video_vimeo',
						'function' => 'vp_dep_boolean',
					),
					'fields'    => array(					
						array(
							'type' => 'upload',
							'name' => 'ozy_enjooy_meta_page_background_video_vimeo_image',
							'label' => __('Poster Image', 'vp_textdomain'),
							'description' => __('Upload or choose a poster image.', 'vp_textdomain'),
						),
						array(
							'type' => 'textbox',
							'name' => 'ozy_enjooy_meta_page_background_video_vimeo_id',
		...
		array(
			'type' => 'radiobutton',
			'name' => 'ozy_enjooy_meta_page_page_model',
