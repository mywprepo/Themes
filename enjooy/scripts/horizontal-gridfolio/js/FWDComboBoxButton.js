...
var FWDComboBoxButton = function(
		...
		self.setupMainContainers = function(){
			...
			//self.text_sdo.getStyle().lineheight = "37px";
			self.text_sdo.getStyle().padding = "0 6px";
			...
			self.text_sdo.setInnerHTML('<span><span class="fa fa-square-o" style="line-height:37px;"></span>' + self.label1_str + '</span>');
