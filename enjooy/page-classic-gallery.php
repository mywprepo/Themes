                ...
                <div class="post-content page-content">
					...
					<?php
                        ...
                        foreach(ozy_grab_ids_from_gallery() as $attachment_id) {
							...
							$output .= '<div class="rsContent" data-rsDelay="6000"><a class="rsImg" href="'. $attachment->guid .'" alt="'. $attachment->post_title .'"></a><div class="infoBlock infoBlockTopLeft infoBlockBlack rsABlock" data-fade-effect="fa;se" data-move-offset="100" data-move-effect="bottom" data-speed="500">'.($attachment->post_title ? '<h4>'. $attachment->post_title .'</h4>' : '').($attachment->post_excerpt ? '<p>'. $attachment->post_excerpt .'</p>' : '').'</div></div>';
                        }
                    ?>
