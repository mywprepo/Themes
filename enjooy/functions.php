...
define( 'OZY_THEMENAME', 'ENJOOY' ); //used in TGM Plugin Activation
...
define( 'OZY_NOTIFIER_THEME_FOLDER_NAME', 'enjooy' );
define( 'OZY_NOTIFIER_XML_FILE', 'http://s3-eu-west-1.amazonaws.com/themeversion/enjooy.xml' );
...
add_action('wp_footer','slider_option');
	...
	if ( function_exists( 'add_image_size' ) ) { 
		add_image_size( 'gridfolio-regular', 278, 188, true );
		add_image_size( 'gridfolio-tall', 278, 384, true );
		add_image_size( 'gridfolio-large', 564, 384, true );
		add_image_size( 'gridfolio-x-large', 800, 600, true );
		add_image_size( 'showbiz', 466, 466, true );
...
$theme_options = new VP_Option(array(
	...
	'option_key' 			=> 'vpt_ozy_enjooy_option', // options key in db, required
