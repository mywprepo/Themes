...
*/
function enjooy_register_required_plugins() {
	...
	$plugins = array(
		array(
			...
			'name'     	=> 'Enjooy Essentials',
			'slug'     	=> 'ozy-enjooy-essentials',
			'source'   	=> get_template_directory() . '/plugins/ozy-enjooy-essentials.zip',
			'required' 	=> true,
			'version'	=> '1.0'
		),array(
			...
			'name'     	=> 'ShowBiz - Premium responsive slider',
			'slug'     	=> 'showbiz',
			'source'   	=> get_template_directory() . '/plugins/showbiz.zip',
			'required' 	=> false,
			'version'	=> '1.7.3'
		),array(
			'name'     	=> 'Real 3D FlipBook',
			'slug'     	=> 'real3d-flipbook',
			'source'   	=> get_template_directory() . '/plugins/real3d-flipbook.zip',
			'required' 	=> false,
			'version'	=> '2.7'
		),array(
...
add_action('tgmpa_register', 'enjooy_register_required_plugins');
