<?php
/*
Template Name: Portfolio : Horizontal Grid Folio
*/
get_header();
...
$params = array(
	'nrOfThumbsToShowOnSet'		=> ($ozy_data->_portfolio_post_per_load <= 0 ? 32 : $ozy_data->_portfolio_post_per_load),
	'scrollBarType' 			=> vp_metabox('ozy_enjooy_meta_page_portfolio.ozy_enjooy_meta_page_portfolio_scroll_type'),
	'SpaceBetweenThumbnails'	=> vp_metabox('ozy_enjooy_meta_page_portfolio.ozy_enjooy_meta_page_portfolio_padding'),
            ...
            <article>
                <div class="post-content page-content">
                    ...
                    <?php
						...
						foreach ($ozy_data->_portfolio_portfolio_categories as $portfolio_category) {
							
							echo '<ul data-cat="' . $portfolio_category->name . '">' . PHP_EOL;
