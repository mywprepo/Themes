...
?>
<article class="<?php echo join( ' ', get_post_class() );?> blog__article__list__item blog__article__link__post <?php echo empty($src)?'-no__image':'';?>">
        ...
        <header>
            ...
            <h3 class="blog__item__title">
                ...
                <a href="<?php echo esc_url($link);?>">
                    <i class="blog__item__icon bicon bi-link-fill"></i>
                </a>
                <?php endif;?>
