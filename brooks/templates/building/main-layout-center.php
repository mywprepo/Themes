                ...
                <div class="col-xs-12 col-sm-6">
                    ...
                    <div class="build__section__col">
                        ...
                        <?php if(!empty($address = rwmb_meta( 'address' ))): ?>
                            <h6 class="build__addres"><i class="icon bicon bi-pin-fill"></i><?php echo esc_html($address, brooks_allowed_html()); ?></h6>
                        <?php endif;?>
                        ...
                        <?php if(!empty($props = rwmb_meta( 'building_props' ))):?>
                            <div class="row">
            ...
            <div class="build__icons__grid">
                <?php foreach($features as $one):?>
                    ...
                    <div class="build__icon">
                        ...
                        <div class="build__icon__value"><?php echo (isset($one['title'])?wp_kses($one['title'], brooks_allowed_html()):'');?></div>
                        <div class="build__icon__name"><?php echo (isset($one['title'])?wp_kses($one['subtitle'], brooks_allowed_html()):'');?></div>
                    </div>
                    <?php endif;?>
