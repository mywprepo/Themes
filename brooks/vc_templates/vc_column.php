...
$output .= '<div class="vc_column-inner ' . esc_attr( trim( vc_shortcode_custom_css_class( $css ) ) ) . ' ' . (!empty( $brooks_column_padding )?$brooks_column_padding:'') . '" ' . ($image_id?('style="background-image: url('.wp_get_attachment_image_url($image_id, 'large').')!important;"'):'').'>';
