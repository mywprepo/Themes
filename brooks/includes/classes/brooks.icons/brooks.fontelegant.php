...
class BrooksClassIconsFontElegant implements iBrooksInterfaceIconCollection {
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = BROOKS_THEMEROOT . "/css/elegant-icons/style.min.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<span aria-hidden="true" class="brooks-icon-font-elegant ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></span>';
