...
class BrooksClassLineaIcons implements iBrooksInterfaceIconCollection {
	...
	public function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = BROOKS_THEMEROOT . "/css/linea-icons/style.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<i class="brooks-icon-linea-icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
