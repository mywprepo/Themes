...
class BrooksClassSimpleLineIcons implements iBrooksInterfaceIconCollection {
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = BROOKS_THEMEROOT . "/css/simple-line-icons/simple-line-icons.css";
    }
    ...
    public function render($icon, $params = array()) {
        ...
        $html .= '<i class="brooks-icon-simple-line-icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString .
            '></i>';
