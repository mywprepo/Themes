...
include BROOKS_INCLUDES."/classes/brooks.icons/brooks.iconcollection.interface.php";
include BROOKS_INCLUDES."/classes/brooks.icons/brooks.fontawesome.php";
include BROOKS_INCLUDES."/classes/brooks.icons/brooks.fontelegant.php";
include BROOKS_INCLUDES."/classes/brooks.icons/brooks.lineaicons.php";
include BROOKS_INCLUDES."/classes/brooks.icons/brooks.simplelineicons.php";
include BROOKS_INCLUDES."/classes/brooks.icons/brooks.peicon7stroke.php";

/*
  Class: BrooksClassIconCollections
  A class that initializes Brooks Icon Collections
 */
...
class BrooksClassIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new BrooksClassIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new BrooksClassIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('linea_icons', new BrooksClassLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('simple_line_icons', new BrooksClassSimpleLineIcons('Simple Line Icons', 'simple_line_icons'));
        $this->addIconCollection('pe_icon_7_stroke', new BrooksClassPeIcons('Pe-icon-7-stroke', 'pe_icon_7_stroke'));
    }
    ...
    public function getIconSizeClass($iconSize) {
        switch($iconSize) {
            case "fa-lg":
                $iconSize = "brooks-tiny-icon";
                break;
            case "fa-2x":
                $iconSize = "brooks-small-icon";
                break;
            case "fa-3x":
                $iconSize = "brooks-medium-icon";
                break;
            case "fa-4x":
                $iconSize = "brooks-large-icon";
                break;
            case "fa-5x":
                $iconSize = "brooks-huge-icon";
                break;
            default:
                $iconSize = "brooks-small-icon";
        }
    ...
    public function getIconCollectionIcons(iBrooksInterfaceIconCollection $collection) {
    ...
    public function enqueueStyles() {
        if(is_array($this->iconCollections) && count($this->iconCollections)) {
            foreach($this->iconCollections as $collection_key => $collection_obj) {
                wp_enqueue_style('brooks_'.$collection_key, $collection_obj->styleUrl);
            }
        }
    }
...
if ( ! function_exists( 'brooks_activate_theme_icons' ) ) {

    function brooks_activate_theme_icons() {
        global $brooks_IconCollections;
        $brooks_IconCollections = BrooksClassIconCollections::get_instance();
    }

    add_action('after_setup_theme', 'brooks_activate_theme_icons');
}