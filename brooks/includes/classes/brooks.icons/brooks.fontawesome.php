...
class BrooksClassIconsFontAwesome implements iBrooksInterfaceIconCollection {
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = BROOKS_THEMEROOT . "/css/font-awesome.min.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<i class="brooks-icon-font-awesome fa ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
